...
set	extensionHuntExpression(XML)	{^((.*\.xml)|(.*\.dtd)|(.*\.ent)|(.*\.xsd)|(.*\.fo)|(.*\.svg))$}
set	extensionTabSize(XML)			4
set	extensionColorScheme(XML)		"Deep Blue"
set	extensionMapName(XML)			"XML"
